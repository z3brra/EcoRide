...
import { EditVehicleModal } from "../vehicles/EditVehicleModal"
    ...
    return (
        <>
            ...
            >
                ...
                <Input label="Date de première immatriculation" placeholder="01/01/1970" type="date" />
            ...
            <EditVehicleModal
                ...
                vehicle={vehicle.find((v) => v.uuid === selectedUuid) || null}
