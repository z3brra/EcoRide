...
class VehicleDTO
{
    #[Assert\NotBlank(message: "License plate is required.", groups: ['create', 'update'])]
    #[Assert\Length(
        min: 2,
    ...
    #[Assert\NotNull(message: "First license date is required.", groups: ['create', 'update'])]
    ...
    #[Assert\NotNull(message: "Is electric flag is required.", groups: ['create', 'update'])]
    public ?bool $isElectric = null;

    #[Assert\NotBlank(message: "Color is required.", groups: ['create', 'update'])]
    #[Assert\Choice(
    ...
    #[Assert\NotNull(message: "Number of seats is required.", groups: ['create', 'update'])]
