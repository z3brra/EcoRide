...
final class Version20250623022557 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE drive (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, vehicle_id INT NOT NULL, uuid VARCHAR(36) NOT NULL, reference VARCHAR(20) NOT NULL, status VARCHAR(20) NOT NULL, available_seats INT NOT NULL, price INT NOT NULL, distance DOUBLE PRECISION NOT NULL, depart VARCHAR(255) NOT NULL, depart_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', arrived VARCHAR(255) NOT NULL, arrived_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', created_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', updated_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', UNIQUE INDEX UNIQ_681DF58FD17F50A6 (uuid), UNIQUE INDEX UNIQ_681DF58FAEA34913 (reference), INDEX IDX_681DF58F7E3C61F9 (owner_id), INDEX IDX_681DF58F545317D1 (vehicle_id), INDEX IDX_681DF58FAEA34913 (reference), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
